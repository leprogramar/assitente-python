    ...
    with sr.Microphone() as source:
        while True:
            ...
            try:
                ...
                print('AGUARDANDO COMANDO', trigger)
...
def executa_comandos(mensagem):
    ...
    # abrir programas do computador
        ...
        os.startfile("https://www.google.com.br/?hl=pt-BR")
...
def main():
    cria_audio("ola.mp3", "Olá sou a Adhara, sua assistente virtual! Como posso ajudar?")
    while True:
        monitora_audio()
